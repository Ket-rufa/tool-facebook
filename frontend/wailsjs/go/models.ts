...
export namespace crawl {
	...
	export class FriendEntity {
	    ...
	    static createFrom(source: any = {}) {
	        return new FriendEntity(source);
	    }
	...
	export class FriendCrawlResponse {
	    success: boolean;
	    message: string;
	    total_count: number;
	    ...
	    static createFrom(source: any = {}) {
	        return new FriendCrawlResponse(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.friends = this.convertValues(source["friends"], FriendEntity);
	    }
